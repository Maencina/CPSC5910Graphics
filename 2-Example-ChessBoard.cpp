...
//vec4 OddOrEven()
//{
//    if ((gl_FragCoord.x % 2 == 0 && gl_FragCoord.y % 2 == 0) || (gl_FragCoord.x % 2 != 0 && gl_FragCoord.y % 2 != 0))
//    {
//        return vec4(0, 0, 0, 1);
//    }
//    else
...
const char *pixelShader = R"(
    ...
    {
        // Draw the squares
        /*if (int(gl_FragCoord.x) % 50 == 0 || int(gl_FragCoord.y) % 50 == 0)
        {
            if ((int(gl_FragCoord.x) % 2 == 0 && int(gl_FragCoord.y) % 2 == 0) || (int(gl_FragCoord.x) % 2 != 0 && int(gl_FragCoord.y) % 2 != 0))
            {
                return vec4(0, 0, 0, 1);
            }
            else
...
int main() {                                                // application entry
    ...
    GLFWwindow *w = glfwCreateWindow(400, 400, "Checkboard", NULL, NULL);
    if (!w)
